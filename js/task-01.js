...
// Searching for titles and numbers of elements in all categories
const showInfoAboutCategories = arrayOfCat.forEach(category =>
    console.log('Category:', category.firstElementChild.textContent, 'has',
        category.lastElementChild.children.length, 'Elements:)'));
